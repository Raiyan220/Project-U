            ...
            >
                <div className="glass backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl p-8 border border-white/20">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-300">Never miss a seat opening again</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-transparent text-gray-400">Or join with</span>
                            </div>
                        </div>
                ...
                <p className="text-center text-gray-500 text-sm mt-6">
                    By signing up, you'll be able to track unlimited courses
                </p>
            </motion.div>
        </div>
    );
